...
public class AoBingEntity extends MonsterEntityBase implements EntityTextureProvider {
    public AoBingEntity(EntityType<? extends HostileEntity> entityType, World world) {
    ...
    public Identifier getTextureId() {
        return Identifier.of(NeZha.MOD_ID, "textures/entity/ao_bing.png");
    }
}
